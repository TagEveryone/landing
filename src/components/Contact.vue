...
const contactMethodsList: ContactMethod[] = [
    {
        icon: 'telegram',
        key: 'telegram',
        link: 'https://matt05.it/4KCNKm'
    },
    {
        icon: 'email',
        key: 'email',
        link: 'https://matt05.it/34oJm0'
    }
];
...
<template>
    <div class="min-h-screen flex flex-col bg-gray-900" id="contact">
        <main class="grow">
            <!-- Hero Section -->
            <section class="bg-linear-to-br from-purple-900 to-indigo-800 py-16">
